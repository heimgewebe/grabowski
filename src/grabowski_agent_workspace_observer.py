...
def _validate_closeout_evidence(
    ...
    if (
        ...
        raise WorkspaceObserverError("external closeout evidence is invalid or unbound")
...
def _observer_report(
    ...
    *,
    ...
    supplied = _validate_closeout_evidence(workspace_id, external_closeout_evidence)
