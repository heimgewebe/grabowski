...
TOOL_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "rlens_preflight": {
        "category": "knowledge",
        "purpose": "Run bounded rLens agent-consumption preflight for a selected bundle.",
        "risk_class": "low",
        "effects": [],
        "reversibility": "not-applicable",
    },
    "rlens_range_get": {
        "category": "knowledge",
        "purpose": "Resolve one bounded rLens/RepoBrief range reference from bundle artifacts.",
        "risk_class": "low",
        "effects": [],
        "reversibility": "not-applicable",
    },
    "rlens_query_existing_index": {
        "category": "knowledge",
        "purpose": "Query a prebuilt RepoBrief index and return bounded snippets/ranges.",
        "risk_class": "low",
        "effects": [],
        "reversibility": "not-applicable",
    },
    "rlens_context_bridge": {
        "category": "knowledge",
        "purpose": "Build a bounded rLens context pack with optional query snippets.",
        "risk_class": "low",
        "effects": [],
        "reversibility": "not-applicable",
    },
