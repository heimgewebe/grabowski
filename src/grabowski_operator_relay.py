...
def operator_relay_protocol() -> dict[str, Any]:
    ...
    return {
        ...
        "operator_failover": {
            "contract": "G6.6-classified-local-first-v1",
            "primary_surface": "grabowski",
            "secondary_surface": "der_kleine_maulwurf",
            "canonical_authority_host": "heim-pc",
            "mode": "local-first-classified-authority-relay",
            "implemented_authority_relays": [
                "systemkatalog",
                "bureau_intake",
            ],
            "failover_triggers": [
                "secondary-local-systemkatalog-root-unavailable",
                "secondary-local-bureau-repository-unavailable",
                "secondary-local-bureau-runtime-unavailable",
            ],
            "never_failover_on": [
                "policy_denial",
                "safety_denial",
            ...
            "failback": "retry-local-authority-first-on-every-operation",
            "mutation_coordination": "existing-g65-heimberry-fence-remains-authoritative",
            "generic_remote_shell_fallback": False,
            "new_public_tool_required": False,
            "does_not_establish": [
                "primary-host-power-loss-recovery",
                "bureau-pickup-failover",
                "automatic-merge-authority",
                "automatic-deploy-authority",
            ],
        },
