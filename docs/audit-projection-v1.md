...
- Emit a separate findings SHA-256 that excludes the numeric window-boundary timestamps but still changes when rolling-window membership or aggregate findings change; the projection SHA-256 remains a complete time-bound receipt.
