...
Target-bound native Git, checkout and GitHub reads provide repository-state evidence. Chronik/Plexer may provide event trace and transport. Event equals evidence; event does not equal command.
