...
| `grabowski_resource_nonconflict_assess` | resource | no | medium | Assess and audit exact same-repository scopes; issue a short hash-bound proof only when every conflict axis is disjoint. |
