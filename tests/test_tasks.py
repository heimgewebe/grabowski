...
if args.command == 'import':
    ...
    receipt['receipt_sha256'] = __import__('hashlib').sha256(unsigned).hexdigest()
...
""",
    ...
    def test_outbox_import_rejects_invalid_receipt_digest_without_success_claim(self) -> None:
