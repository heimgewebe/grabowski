  ...
  send(raw) {
    ...
    switch (request.method) {
      ...
      case 'DOM.describeNode': {
        ...
        if (readAncestorOpacityFallbackScenario || readTextHeavyPageFallbackScenario) {
          reply({node: {
            backendNodeId: 101,
            nodeType: 1,
            localName: 'button',
